...
class EsIndexManagementCli {
  ...
  constructor() {
    this.ROOT_PATH = '/es-index-management/'
  }
  ...
  async copy(args) {
    args.path = this.ROOT_PATH + args.modelName+'/recreate-index/'+args.indexName;
  ...
  async taskStatus(args) {
    args.path = this.ROOT_PATH + 'task-status/'+args.taskId;
